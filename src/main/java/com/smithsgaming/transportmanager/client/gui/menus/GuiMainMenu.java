...
public class GuiMainMenu extends GuiScreen implements IButtonListener {
    ...
    protected void loadGui() {
        ...
        registerComponent(new GuiButton(0,
                                         this,
                                         new GuiText(this, TextureRegistry.Fonts.Courier, "Create new Game", new Vector2i(0, 0), true, Color.WHITE),
                                         new GuiPlaneI(new Vector2i((int) (horizontalHalf - 20 - TextureRegistry.Fonts.Courier.getOccupiedAreaForText("Create new Game")
                                                                                                   .getWidth()), (int) (verticalHalf - 10)),
                                                        new Vector2i((int) (horizontalHalf - 10), (int) (verticalHalf - 20 - TextureRegistry.Fonts.Courier.getLineHeight()))),
                                         true,
                                         this));
    }
